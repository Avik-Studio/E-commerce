...
export default function Contact() {
  ...
  return (
    <>
      <div className="isolate bg-white px-6  lg:px-8 my-5 py-5">
        {/* <div
          aria-hidden="true"
            ...
            <div>
              ...
              <div className="mt-2.5">
                <input
                  ...
                  className="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600"
                />
              </div>
            </div>
            <div>
              ...
              <div className="mt-2.5">
                <div className="flex rounded-md bg-white outline outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-gray-600">
                  <div className="grid shrink-0 grid-cols-1 focus-within:relative">
                    ...
                    <i className="fa-solid fa-angle-down pointer-events-none col-start-1 row-start-1 mr-2 size-5 self-center justify-self-end text-gray-500 sm:size-4"></i>
                  </div>
                  <input
                    id="phone-number"
                    name="phone-number"
